...
export default class ProviderUpdateScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <KeyboardAvoidingView behavior='position' style={styles.container} > 
        <Animatable.View  animation='fadeInUpBig'  >
          ...
          <TouchableOpacity style={styles.buttonlogin} onPress={() => this.props.navigation.navigate('ProviderProfile')}>
